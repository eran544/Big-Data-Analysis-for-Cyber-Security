...
# #-------------Get the data-----------
malFile = pd.read_csv('malicious files day data.csv')[["Sha1ID","Malicious", "Mean", "Std", "Size","WebFileUrlDomain"]]
cleanFile = pd.read_csv('clean files day data.csv')[["Sha1ID","Malicious", "Mean", "Std", "Size","WebFileUrlDomain"]]
...
features.columns = ["Sha1ID","Malicious","Day count Mean","Day count STD","Size","WebFileUrlDomain","DTW k-mean","DTW k-median","DTW k-STD","DTW k-Malicious(%)",
